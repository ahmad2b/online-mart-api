...
POSTGRES_SERVER = os.getenv("POSTGRES_SERVER") or "postgres-notification"
POSTGRES_PORT = os.getenv("POSTGRES_PORT") or "5432" 
POSTGRES_USER = os.getenv("POSTGRES_USER") or "user" 
POSTGRES_PASSWORD = os.getenv("POSTGRES_PASSWORD") or "password"
POSTGRES_DB = os.getenv("POSTGRES_DB") or "notificationdb"
...
class Settings(BaseSettings):
    ...
    # TODO: update type to EmailStr when sqlmodel supports it
    FIRST_SUPERUSER: str = "mahmadshoukat7@gmail.com"
